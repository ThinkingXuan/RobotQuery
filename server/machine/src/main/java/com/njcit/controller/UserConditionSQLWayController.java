...
public class UserConditionSQLWayController {

    @Autowired
    @Qualifier("userConditionSQLService")
    UserConditionSQLService userConditionSQLService;
    ...
    public String getUserContactWay(HttpServletRequest request) throws IOException {
        ...
        System.out.println( userConditionSQLService.getUserConditioin(templateModelBean));
        return userConditionSQLService.getUserConditioin(templateModelBean);
    }
