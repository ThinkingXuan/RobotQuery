...
public class UserTaskController {
    ...
    @Autowired
    @Qualifier("userTaskService")
    UserTaskService userTaskService;


    @ResponseBody
    @RequestMapping(value = "/getUserTask.action", method = RequestMethod.POST)
    public String getUserTask(HttpServletRequest request) throws IOException {
        ...
        return userTaskService.getUserTask(templateModelBean);
