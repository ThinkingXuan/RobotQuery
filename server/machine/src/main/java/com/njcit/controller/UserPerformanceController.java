...
public class UserPerformanceController {
    ...
    public String getUserPerformance(HttpServletRequest request) throws IOException {
        ...
        System.out.println(userPerformanceService.getUserPerformance(templateModelBean));
        return  userPerformanceService.getUserPerformance(templateModelBean);
