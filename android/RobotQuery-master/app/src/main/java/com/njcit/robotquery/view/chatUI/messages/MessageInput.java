...
public class MessageInput extends RelativeLayout
    ...
    protected ImageButton messageVoiceButton;
    protected EditText messageInput;
    protected TextView messageVoiceInput;
    ...
    public void onClick(View view) {
        ...
        } else if (id == R.id.messageVoiceButton) {

            if (messageVoiceInput.getVisibility() == View.GONE) {
                messageVoiceInput.setFocusable(true);
                messageInput.setVisibility(View.GONE);
                messageVoiceInput.setText("点击 说话");
                messageVoiceButton.setBackground(getResources().getDrawable(R.drawable.ic_keyboard_blue_500_24dp));
                messageVoiceInput.setVisibility(View.VISIBLE);
            } else {
                messageInput.setVisibility(View.VISIBLE);
                messageVoiceButton.setBackground(getResources().getDrawable(R.drawable.ic_keyboard_voice_blue_500_24dp));
                messageVoiceInput.setVisibility(View.GONE);
            }

        }else if(id == R.id.messageVoiceInput){
            inputListener.onVoiceInput(view);
    ...
    private void init(Context context) {
        ...
        messageVoiceButton = (ImageButton) findViewById(R.id.messageVoiceButton);
        messageVoiceInput = (TextView) findViewById(R.id.messageVoiceInput);
        buttonSpace = (Space) findViewById(R.id.buttonSpace);

        messageVoiceButton.setOnClickListener(this);
        messageSendButton.setOnClickListener(this);
        messageInput.addTextChangedListener(this);
        messageVoiceButton.setOnClickListener(this);
        messageVoiceInput.setOnClickListener(this);
        messageInput.setText("");
    }
    ...
    public interface InputListener {
         ...
         * @return
         */
        boolean onVoiceInput(View view);
    }


    public void showInput(String str){
        if (messageInput.getVisibility() == View.GONE&& messageVoiceInput.getVisibility() == View.VISIBLE){
            messageVoiceInput.setVisibility(GONE);
            messageInput.setVisibility(View.VISIBLE);
            messageVoiceButton.setBackground(getResources().getDrawable(R.drawable.ic_keyboard_voice_blue_500_24dp));
    ...
    public void setMessageVoiceInputText(String str){
        messageVoiceInput.setText(str);
    }
}
