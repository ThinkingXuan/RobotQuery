...
import com.njcit.robotquery.databinding.ActivityTrainConfigureBinding;
...
public class TrainActivity extends BaseActivity<ActivityTrainConfigureBinding> implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_train_configure);
        initView();
        initData();
    }
    ...
    private void initData() {
        ...
        if (SharedPreUtil.getString(getApplicationContext(), Constants.TEMPLATE_TRAIN_IS_FINISH, "").equals("1")) {
            mTemplateBean = (TemplateBean) SharedPreUtil.getObject(getApplicationContext(), Constants.TEMPLATE_TRAIN);
        ...
        if (null == mTemplateBean) {
            ...
            mTemplateBean.setTemplateId(Constants.TEMPLATE_TRAIN);
    ...
    private void initView() {
        ...
        bindingView.btChoseTrain.setOnClickListener(this);
    ...
    private void SaveTemplate() {
        ...
        if (mMap.size() >= 0 && mMap != null) {
            ...
            SharedPreUtil.saveObject(getApplicationContext(), Constants.TEMPLATE_TRAIN,mTemplateBean);
            SharedPreUtil.setString(getApplicationContext(), Constants.TEMPLATE_TRAIN_IS_FINISH, "1");
        }
    }
        ...
        Subscription subscription = ApiManage.getInstence().getUpdatetModelService().updateModel(body)
                ...
                .subscribe(new Observer<BaseBean>() {
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(TrainActivity.this, "保存失败", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onNext(BaseBean baseBean) {
                        if (baseBean.getCode().equals("1")) {
                            bindingView.progressBar.setVisibility(View.GONE);
                            Toast.makeText(TrainActivity.this, "保存成功", Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            Toast.makeText(TrainActivity.this, "保存失败", Toast.LENGTH_SHORT).show();
