...
import com.njcit.robotquery.view.chatUI.commons.Style;
...
public class MessagesListStyle extends Style {
    ...
    public Drawable getMessageSelector(@ColorInt int normalColor, @ColorInt int selectedColor, @ColorInt int pressedColor, @DrawableRes int shape) {
