package com.njcit.robotquery.view.flexbox.adapter;
...
import com.njcit.robotquery.view.flexbox.interfaces.TagWithListener;
import com.njcit.robotquery.view.flexbox.widget.BaseTagView;
import com.njcit.robotquery.view.flexbox.widget.TagFlowLayout;
            ...
            view.setListener(new TagWithListener<T>() {
                ...
                public void onItemSelect(T item) {
                    if (onSubscribeListener!=null){
                        onSubscribeListener.onItemClickListener(item);
                    }
