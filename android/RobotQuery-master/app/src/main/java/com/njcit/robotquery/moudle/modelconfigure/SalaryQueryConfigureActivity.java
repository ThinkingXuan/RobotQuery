...
import com.njcit.robotquery.databinding.ActivitySalaryQueryConfigureBinding;
...
public class SalaryQueryConfigureActivity extends BaseActivity<ActivitySalaryQueryConfigureBinding> implements View.OnClickListener {
    public static final String TAG = "SalaryQueryConfigureActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salary_query_configure);
        initView();
        initData();
    }
    ...
    private void initData() {
        ...
        if (SharedPreUtil.getString(getApplicationContext(), Constants.TEMPLATE_SALARY_IS_FINISH, "").equals("1")) {
            mTemplateBean = (TemplateBean) SharedPreUtil.getObject(getApplicationContext(), Constants.TEMPLATE_SALARY);
        ...
        if (null == mTemplateBean) {
            ...
            mTemplateBean.setTemplateId(Constants.TEMPLATE_SALARY);
    ...
    private void initView() {
        ...
        bindingView.btChoseSalaryQuery.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.bt_chose_salary_query:
    ...
    private void SaveTemplate() {
        ...
        if (mMap.size() >= 0 && mMap != null) {
            ...
            SharedPreUtil.saveObject(getApplicationContext(), Constants.TEMPLATE_SALARY,mTemplateBean);
            SharedPreUtil.setString(getApplicationContext(), Constants.TEMPLATE_SALARY_IS_FINISH, "1");
        }
    }
        ...
        Subscription subscription = ApiManage.getInstence().getUpdatetModelService().updateModel(body)
                ...
                .subscribe(new Observer<BaseBean>() {
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(SalaryQueryConfigureActivity.this, "保存失败", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onNext(BaseBean baseBean) {
                        if (baseBean.getCode().equals("1")) {
                            bindingView.progressBar.setVisibility(View.GONE);
                            Toast.makeText(SalaryQueryConfigureActivity.this, "保存成功", Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            Toast.makeText(SalaryQueryConfigureActivity.this, "保存失败", Toast.LENGTH_SHORT).show();
