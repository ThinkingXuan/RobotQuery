...
public class SubscribeBean implements Serializable {
    ...
    private List<DayRecommedBean.DataBean> ResultList;
    ...
    public List<DayRecommedBean.DataBean> getResultList() {
        return ResultList;
    }

    public void setResultList(List<DayRecommedBean.DataBean> ResultList) {
